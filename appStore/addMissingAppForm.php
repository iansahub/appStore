...
write_to_log("STEP 15 - CODER TO DECLARE OWN VARIABLES","start_step");
	...
	$$nameSpaceID['var']['newIncidentLink'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 0, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "includeInResponse" => true, "info" => "an example of a variable set in the template script, in this instance it is to be associated with a text input"); 
	$$nameSpaceID['var']['newRFCLink'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 0, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "includeInResponse" => true, "info" => "an example of a variable set in the template script, in this instance it is to be associated with a text input"); 
	$$nameSpaceID['var']['newRFILink'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 0, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "includeInResponse" => true, "info" => "an example of a variable set in the template script, in this instance it is to be associated with a text input"); 
...
<link href="/<?php echo $$nameSpaceID['templateVar']['appInfo']['val']['appRoot'];?>/stylesheets/tagcloud.css" rel="stylesheet" >


<!--<link href="/<?php //echo $$nameSpaceID['templateVar']['appInfo']['val']['appRoot'];?>/stylesheets/mod.css" rel="stylesheet" media="all">-->
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	<div class="app-width-container app-main-wrapper"><!--main layout wrapper-->
		...
		<main id="main-content" role="main">
			<!--main page header-->
			<h1 class="govuk-heading-xl" id="H1MainTitle">
				<?php echo $$nameSpaceID['DOM']['H1MainTitle']['innerHTML'] ?? "App Store" ;?>
			</h1>
			...
			<form id="<?php echo $nameSpaceID . "_form";?>" accept-charset="utf-8" action="process_addMissingAppForm.php" name="<?php echo $nameSpaceID . "_form";?>" method="POST">
				<fieldset>
					
					<!--text-input component-->
					<?php $nameOfInputField = 'shortName'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
						<div id="<?php echo $nameOfInputField;?>Tip" class="govuk-hint">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?>
						</div>                
						<div class="govuk-error-message" id="<?php echo $nameOfInputField;?>Error"  >
							<?php if(count($$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']) > 0){
								echo implode(",", $$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);}else{ echo '&nbsp;';}
							?>
						</div>
						<input 
						tabindex="1" 
						accesskey="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['accesskey'];?>" 
						type="text"
						name="<?php echo $nameOfInputField;?>" 
						id="<?php echo $nameOfInputField;?>" 
						size="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['maxlength'];?>" 
						title="" 
						class="form-control field <?php echo $$nameSpaceID['templateVar']['loc']['val'];?> govuk-input"
						autocomplete ="off"
						placeholder="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['placeholder'];?>"
						value="<?php echo $$nameSpaceID['var'][$nameOfInputField]['val'];?>";
						required="required" 
						minlength="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['minlength'];?>" 
						maxlength="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['maxlength'];?>" 
						pattern="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['pattern'];?>"
						data-infomsg=""
						>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'medName'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'longName'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'shortDescription'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text area component-->
					<?php $nameOfInputField = 'longDescription'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
						...
						<textarea 
						class="form-control field <?php echo $$nameSpaceID['templateVar']['loc']['val'];?> govuk-textarea"
						id="<?php echo $nameOfInputField;?>"						
						name="<?php echo $nameOfInputField;?>" 
						rows="5" 
						aria-describedby="<?php echo $nameOfInputField;?>-hint"
						autofocus="" 
						cols=""
						dirname=""
						placeholder="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['placeholder'];?>"
						...
						pattern="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['pattern'];?>"
						data-infomsg=""
						><?php echo $$nameSpaceID['var'][$nameOfInputField]['val'];?></textarea>
						<div class="clearRow">&nbsp;</div>
					</div>
					<div class="clearRow">&nbsp;</div>
					<!--end of textarea component-->
					
					<!--image picker component-->
					<?php $nameOfInputField = 'icon'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						...
						<div id="<?php echo $nameOfInputField;?>Preview" 
						style="width:8em;height:8em;border:1px solid gray;background: url(/kloud/getPic.php?UID=<?php echo $image;?>) center/contain no-repeat, linear-gradient(45deg, #ccc 25%, transparent 25%) 0 0/20px 20px repeat, linear-gradient(45deg, transparent 75%, #ccc 75%) 0 0/20px 20px repeat, linear-gradient(45deg, transparent 75%, #ccc 75%) -10px -10px/20px 20px repeat, linear-gradient(45deg, #ccc 25%, transparent 25%) 10px 10px/20px 20px repeat" onclick="$('#modal-form-image').modal('show');"></div>	
						<input 
						tabindex="1" 
						accesskey="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['accesskey'];?>" 
						type="hidden"
						...
						autocomplete ="off"
						placeholder="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['placeholder'];?>"
						onfocus="this.reportValidity();$('#modal-form-image').modal('show');"
						value="<?php echo $image;?>"
						<?php if(array_key_exists('required', $$nameSpaceID['DOM'][$nameOfInputField])){
					...
					<div class="clearRow">&nbsp;</div>
					<!--end of image picker component-->
					
					
					
					<!--colour picker component-->
					<?php $nameOfInputField = 'iconColour'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container"class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<div class="govuk-error-message" id="<?php echo $nameOfInputField;?>Error"  >
							<?php if(count($$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']) > 0){
								echo implode(",", $$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);}else{ echo '&nbsp;';}
						...
						<div class="mod-dos-uk-colour">
							<input 
							tabindex="1" 
							accesskey="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['accesskey'];?>" 
							type="color" 
							name="<?php echo $nameOfInputField;?>" 
							id="<?php echo $nameOfInputField;?>" 
							title="" 
							class="form-control field <?php echo $$nameSpaceID['templateVar']['loc']['val'];?> mod-dos-uk-colour__input" 
							autocomplete="off" 
							value="1" 
							data-infomsg="">
							<label 
								id="<?php echo $nameOfInputField;?>Label" 
								class="govuk-label mod-dos-uk-colour__label" 
								for="<?php echo $nameOfInputField;?>"
							>
								<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
							</label>
							<div id="<?php echo $nameOfInputField;?>Tip" class="govuk-hint mod-dos-uk-colour__hint">
								<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?>
							</div>						
						</div><!--end of color+label+tip group-->
						<div class="clearRow">&nbsp;</div>
					</div>
					<!--end of colour picker component-->
					
					<!--number component--> 
					<!--text-input with property inputmode="numeric" and input class of govuk-!-width-one-quarter-->
					<?php $nameOfInputField = 'sortOrder'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
						...
						size="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['maxlength'];?>" 
						title="" 
						class="form-control field <?php echo $$nameSpaceID['templateVar']['loc']['val'];?> govuk-input govuk-!-width-one-quarter"
						autocomplete ="off"
						placeholder="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['placeholder'];?>"
						value="<?php echo $$nameSpaceID['var'][$nameOfInputField]['val'] ?? '0';?>";
						required="required" 
						minlength="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['minlength'];?>" 
						maxlength="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['maxlength'];?>" 
						pattern="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['pattern'];?>"
					...
					<div class="clearRow">&nbsp;</div>
					<!--end of number component-->

					<!--radio component-->
					<?php $nameOfInputField = 'publishStatus'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
							...
							<div class="govuk-radios" data-module="govuk-radios">
								<div class="govuk-radios__item">
									<input 
										...
										id="<?php echo $nameOfInputField;?>-1" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-1']['value'];?>"
										<?php if(array_key_exists('required', $$nameSpaceID['DOM'][$nameOfInputField.'-1'])){
											echo 'required="required"';
										}?>	
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-1']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-1';?>" for="<?php echo $nameOfInputField;?>-1">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-1']['innerHTML'];?>
										<span style="display:block"  id="<?php echo $nameOfInputField;?>Tip-1" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-1']['innerHTML'];?>
										</span> 
									</label>
								</div>
								<div class="govuk-radios__item">
									<input 
										class="govuk-radios__input" 
										id="<?php echo $nameOfInputField;?>-2" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-2']['value'];?>"
										<?php if(array_key_exists('required', $$nameSpaceID['DOM'][$nameOfInputField.'-1'])){
											echo 'required="required"';
										}?>
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-2']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-2';?>" for="<?php echo $nameOfInputField;?>-2">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-2']['innerHTML'];?>
										<span style="display:block" id="<?php echo $nameOfInputField;?>Tip-2" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-2']['innerHTML'];?>
										</span> 
									</label>
								</div>
								<div class="govuk-radios__item">
									<input 
										class="govuk-radios__input" 
										id="<?php echo $nameOfInputField;?>-3" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-3']['value'];?>"
										<?php if(array_key_exists('required', $$nameSpaceID['DOM'][$nameOfInputField.'-1'])){
											echo 'required="required"';
										}?>
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-3']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-3';?>" for="<?php echo $nameOfInputField;?>-3">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-3']['innerHTML'];?>
										<span style="display:block" id="<?php echo $nameOfInputField;?>Tip-3" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-3']['innerHTML'];?>
										</span> 
									</label>
								</div>
								...
								<div class="govuk-radios__item">
									<input 
										class="govuk-radios__input" 
										id="<?php echo $nameOfInputField;?>-4" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-4']['value'];?>"
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-4']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-4';?>" for="<?php echo $nameOfInputField;?>-4">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-4']['innerHTML'];?>
										<span style="display:block" id="<?php echo $nameOfInputField;?>Tip-4" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-4']['innerHTML'];?>
										</span> 
									</label>
								</div>
								...
								<div class="govuk-radios__item">
									<input 
										class="govuk-radios__input" 
										id="<?php echo $nameOfInputField;?>-5" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-5']['value'];?>"
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-5']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-5';?>" for="<?php echo $nameOfInputField;?>-5">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-5']['innerHTML'];?>
										<span style="display:block" id="<?php echo $nameOfInputField;?>Tip-5" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-5']['innerHTML'];?>
										</span> 
									</label>
								</div>
								...
								<div class="govuk-radios__item">
									<input 
										class="govuk-radios__input" 
										id="<?php echo $nameOfInputField;?>-6" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-6']['value'];?>"
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-6']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-6';?>" for="<?php echo $nameOfInputField;?>-6">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-6']['innerHTML'];?>
										<span style="display:block" id="<?php echo $nameOfInputField;?>Tip-6" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-6']['innerHTML'];?>
										</span> 
									</label>
								</div>
								...
								<div class="govuk-radios__item">
									<input 
										class="govuk-radios__input" 
										id="<?php echo $nameOfInputField;?>-7" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-7']['value'];?>"
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-7']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-7';?>" for="<?php echo $nameOfInputField;?>-7">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-7']['innerHTML'];?>
										<span style="display:block" id="<?php echo $nameOfInputField;?>Tip-7" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-7']['innerHTML'];?>
										</span> 
									</label>
								</div>
								...
								<div class="govuk-radios__item">
									<input 
										class="govuk-radios__input" 
										id="<?php echo $nameOfInputField;?>-8" 
										name="<?php echo $nameOfInputField;?>" 
										type="radio" 
										value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'-8']['value'];?>"
										<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField.'-8']['value']){
											echo 'checked="checked"';
										}?>
										
									>
									<label class="govuk-label govuk-radios__label" id="<?php echo $nameOfInputField.'Label-8';?>" for="<?php echo $nameOfInputField;?>-8">
										<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label-8']['innerHTML'];?>
										<span style="display:block" id="<?php echo $nameOfInputField;?>Tip-8" class="govuk-hint">
											<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip-8']['innerHTML'];?>
										</span> 
									</label>
								</div>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'primaryClient'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'primaryClientUIN'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'protocol'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!-- ********************* START: ICS Test 17/12/2025 ********************* -->
					<div class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
					<?php $nameOfInputField = 'maturity'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					...
					<div class="inputErrorMessage govuk-error-message" id="<?php echo $nameOfInputField;?>Error"  >
						<?php if(count($$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']) > 0){
							echo implode(",", $$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);}else{ echo '&nbsp;';}
						?>
					</div>
				...
				<div class="clearRow">&nbsp;</div>
					...
					<!-- ********************* END:   ICS Test 17/12/2025 ********************* ->
					
					<!--text-input component-->
					<?php $nameOfInputField = 'devDomain'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container"  class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'testDomain'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container"  class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'prodDomain'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container"  class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'appRoot'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--text-input component-->
					<?php $nameOfInputField = 'homePage'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--url-input component-->
					<?php $nameOfInputField = 'legalAndPolicyLink'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
						<div id="<?php echo $nameOfInputField;?>Tip" class="inputTip govuk-hint"><?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?></div>				
						<div class="govuk-error-message" id="<?php echo $nameOfInputField;?>Error"  ><?php if(count($$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']) > 0){
							echo implode(",", $$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);}else{ echo '&nbsp;';}?>
						</div>
						<input 
						tabindex="1" 
					...
					<div class="clearRow">&nbsp;</div>
					<!--end of url input component-->
					
					<!--url-input component-->
					<?php $nameOfInputField = 'secureAnAccountLink'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--checkbox component-->
					<?php $nameOfInputField = 'allowNewIncidents'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<div id="<?php echo $nameOfInputField;?>Tip" class="govuk-hint">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?>
						</div>	
						...
						<div class="govuk-checkboxes__item">
							...
							id="<?php echo $nameOfInputField;?>" 
							title="" 
							class="form-control field <?php echo $$nameSpaceID['templateVar']['loc']['val'];?> govuk-checkboxes__input" 
							autocomplete="off" 
							value="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['value'];?>" 
							<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == $$nameSpaceID['DOM'][$nameOfInputField]['value']){
								echo 'checked="checked"';
							}?>
							data-infomsg="">
							<label 
						...
						</div><!--end of checkbox+label group-->
						<div class="clearRow">&nbsp;</div>
					</div>
					<!--end of checkbox component-->
					
					<!--url-input component-->
					<?php $nameOfInputField = 'newIncidentLink'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--checkbox component-->
					<?php $nameOfInputField = 'allowNewRFCs'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<div id="<?php echo $nameOfInputField;?>Tip" class="govuk-hint">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?>
						</div>	
					...
					<!--url-input component-->
					<?php $nameOfInputField = 'newRFCLink'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--checkbox component-->
					<?php $nameOfInputField = 'allowNewRFIs'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<div id="<?php echo $nameOfInputField;?>Tip" class="govuk-hint">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?>
						</div>	
						<div class="govuk-error-message" id="<?php echo $nameOfInputField;?>Error"  >
					...
					<!--url-input component-->
					<?php $nameOfInputField = 'newRFILink'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<?php $nameOfInputField = 'adminEmail'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
						<div id="<?php echo $nameOfInputField;?>Tip" class="inputTip govuk-hint">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?>
						</div>                
						<div class="govuk-error-message" id="<?php echo $nameOfInputField;?>Error"  >
							<?php if(count($$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']) > 0){
					...
					<div class="clearRow">&nbsp;</div>
					<!--end of email-input component-->
					
					
					
					<!--tag-cloud component-->
					<?php $nameOfInputField = 'otherSMEs'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<div id="<?php echo $nameOfInputField;?>Container" class="govuk-form-group <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>">
						<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel govuk-label" for="<?php echo $nameOfInputField;?>">
							<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
						</label>
					...
					<!--if i have javascript-->
				
					<ul class="tagCloud " data-inputfield="<?php echo $nameOfInputField;?>" id="<?php echo $nameOfInputField;?>TagCloud" style="display:none" onclick="document.getElementById('<?php echo $nameOfInputField;?>Input').focus();" >
						<?php
						foreach($$nameSpaceID['var'][$nameOfInputField]['val'] as $$nameSpaceID['var'][$nameOfInputField]['tmpVal']  ){
							if($$nameSpaceID['var'][$nameOfInputField]['tmpVal'] != ""){
								echo '<li class="govuk-tag--blue tagCloud-tag"><span class="tagCloud-tag-label">'. $$nameSpaceID['var'][$nameOfInputField]['tmpVal'] .'</span><button class="tagDeleteButton" tabindex="99"><sup>x</sup></button></li>';						
							}
						}
						?>
						<div  class="input-sizer"><!--input-sizer makes the input box dynamically fit its contents-->
							<!--prevent this from being submitted with the form by setting its form property to blank-->
							<input 
								class="tagcloudInput ignoreClientsideErrors"
								tabindex="1" 
								id="<?php echo $nameOfInputField;?>Input" 
								name="<?php echo $nameOfInputField;?>Input" 
								type="email" 
								spellcheck="false"
								form="" 
						...
						<!--hidden comma-separated string (when JS is available)-->
						<input 
							type="hidden" 
							id="<?php echo $nameOfInputField;?>" 
							name="<?php echo $nameOfInputField;?>" 
							value = "<?php echo implode(";",$$nameSpaceID['var'][$nameOfInputField]['val']);?>"
							spellcheck="false"
						>	
						</input>
					...
					<script>			
						window.onload = function(){
							document.getElementById("<?php echo $nameOfInputField;?>TagCloud").style.display = 'block';
						}	
					</script>
					<!--if no script, revert to a comma-seperated list only-->
					<noscript>
						<input 
							type="text" 
							id="<?php echo $nameOfInputField;?>" 
				...
				<!--end of tagCloud component-->
					...
					<div class="buttonRow">
						<?php         
						if (str_replace('\\', '/', __FILE__) == $_SERVER['SCRIPT_FILENAME']) { ?>
						<button tabindex="11" class="topWindowOnly" id="<?php echo $nameSpaceID . "_form";?>Cancel" accesskey="<?php echo $$nameSpaceID['DOM'][$nameSpaceID.'_formCancel']['accesskey'] ?? '';?>" type="button" value="Cancel" onclick="location.href='<?php echo $$nameSpaceID['templateVar']['previousURLQS']['val'];?>';" >
							<?php echo $$nameSpaceID['DOM'][$nameSpaceID.'_formCancel']['innerHTML'] ?? ($nameSpaceID . '_formCancel button text not defined in DOMContent.php');?>
						</button>
						...
						<button tabindex="10"  class="disableIfFormIsInvalid"  id="<?php echo $nameSpaceID . "_form";?>Save" accesskey="<?php echo $$nameSpaceID[$nameSpaceID.'_formSave']['accesskey'] ?? '';?>" type="submit" value="Update details" onclick="return <?php echo $nameSpaceID;?>.preSubmitCheck();">
							<?php echo $$nameSpaceID['DOM'][$nameSpaceID.'_formSave']['innerHTML'] ?? ($nameSpaceID . '_formSave button text not defined in DOMContent.php');?>
						</button>
					</div>
