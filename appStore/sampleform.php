...
FILE DESCRIPTION:
bASED ON PROCESS_SAmpleform , pulling into this file things from original
sampleform to end up with this as teh new sampleform file so 'prefer'
things in here.
...
write_to_log("STEP 5 - 'DECLARE CRITICAL TEMPLATE VARIABLES'","start_step"); 
	...
	*/
	...
	$$nameSpaceID['templateVar']['debugging'] = array("val"=> false, "DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	...
	"DIRTY" => "", "tmpVal" => "", "argType" => -1, "mval"=> false, "count" => 0,"varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
...
write_to_log("STEP 7 - RESUME DECLARING TEMPLATE VARIABLES","start_step");
	...
	$$nameSpaceID['templateVar']['userLocalTimeZone'] = array("val"=> "Europe/London", "DIRTY" => "", "argType" => -1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
...
write_to_log("STEP 8 - 'RESUME DECLARING TEMPLATE VARIABLES (2)'","start_step");		
	...
	$$nameSpaceID['templateVar']['includeSecurity']  = array("val" => false, "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mVal"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	...
	"tmpVal" => "", "argType" => -1, "mVal"=> true, "count" => 3, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	...
	$$nameSpaceID['templateVar']['r2lLocaleScripts']  = array("val"=> array('Arab','Hebr','Nkoo','Syrc','Thaa','Tfng'), "argType" => -1, "mVal"=> true, "count" => 6 , "varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	...
	$$nameSpaceID['templateVar']['r2l'] =  array("val"=> false, "argType" => -1, "mVal"=> false, "count" => 0 , "varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	...
	"varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	"BELONGS TO THE TEMPLATE.  a list of locales with the associated language presented once its local langauge and again in english (for the developers convenience). This is used
	...
	"DIRTY" => "", "tmpVal" => "", "argType" => -1, "mval"=> true, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	...
	$$nameSpaceID['templateVar']['QUARANTINE_DIRTY'] 		= array("val"=> array(), "DIRTY" => "", "tmpVal" => "", "argType" => -1, "mval"=> true, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	...
	$$nameSpaceID['templateVar']['error'] = array("val"=> "", "DIRTY" => "",  "tmpVal" => "", "argType" => 0, "mval"=> false, "count" => -1, "varSpecificErrs" => array(),"mustPassOn" => false, "info" => "
	...
	$$nameSpaceID['templateVar']['errorInt'] = array("val"=> 0, "DIRTY" => "","tmpVal" => "", "argType" => -1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "
	where the error variable is found to hold a decimal fraction number eg 3.9, this holds the 3
	");
	
	$$nameSpaceID['templateVar']['errorDec'] = array("val"=> 0, "DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "
	...
	"DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	...
	$$nameSpaceID['templateVar']['invalidCharacters']  = array("val"=>  array("'", "\"", "<", ">", "/", "\\", ";", ":", "`", "{", "}"), "argType" => -1, "mVal"=> true, "count" => 11, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	...
	$$nameSpaceID['templateVar']['sr'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => 0, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	BELONGS TO THE TEMPLATE.  used as a non-error 'good' response code from the server like 'your input was successfully saved' 
	");
	
	$$nameSpaceID['templateVar']['srInt'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	BELONGS TO THE TEMPLATE.  
	where the sr variable is found to hold a decimal fraction number eg 1.6, this holds the 1
	");
	
	$$nameSpaceID['templateVar']['srDec'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	BELONGS TO THE TEMPLATE.  
	where the sr variable is found to hold a decimal fraction number eg 1.6, this holds the 6
	");
	
	$$nameSpaceID['templateVar']['srTimeElapsed'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	BELONGS TO THE TEMPLATE.  
	...
	$$nameSpaceID['templateVar']['JSONErrors'] = array("val"=> array(), "DIRTY"=> "", "argType" => -1, "mVal"=> false, "count" => 0, "mustPassOn" => false, "info" => "
	...
	"argType" => -1, "mVal"=> true, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	...
	\${\$nameSpaceID}['templateVar]['includeSecurity']['val'] is set to false");
		...
		//thought: i could make this a global by not putting it into the namespace but otherwise keep the same structure to the variable.
	$$nameSpaceID['templateVar']['appStore_link'] =  array( "val" => array("db_conn_file" =>  $_SERVER['DOCUMENT_ROOT']."/klogin/appStore_database.php"), "argType" => -1, "mVal"=> true, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => 
	"BELONGS TO THE TEMPLATE.  the variable holds a value 'db_conn_file' set by the coder to point to a php file which establishes a connection
...
write_to_log("STEP 12 - RESUME DECLARING TEMPLATE VARIABLES (3)","start_step");
	...
	), "DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> true, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	...
	$$nameSpaceID['templateVar']['sql'] 			= array("val"=>"", "query"=> "", "stmt"=>"", "result"=> "", "row"=>"", "rows"=>"", "rowCount"=>"", "DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	...
	$$nameSpaceID['templateVar']['rkey'] 				= array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	...
	$$nameSpaceID['templateVar']['vKey'] 				= array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	array key an etheral variable which holds a single key (name) from any array as the array is iterated through. the named key equivalent of the traditional and ubiquitous 'i' 
	variable for arrays keyed with integers");
	...
	$$nameSpaceID['templateVar']['previousURLQS'] 				= array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	holds the url (including query string) of the last page visited if known");

	$$nameSpaceID['templateVar']['currentURLQS'] 				= array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	holds the url (including query string) of the current page");

	$$nameSpaceID['templateVar']['currentHost'] 				= array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
	holds the hostname of the current page");

	$$nameSpaceID['templateVar']['nextURLQS'] 				= array("val"=> "", "DIRTY" => "", "tmpVal" => "",  "argType" => -1, "mval"=> false, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => false, "info" => "
...
write_to_log("STEP 14 - TRY TO GET THIS APP'S INFO FROM APPSTORE DB","start_step");
	...
	$$nameSpaceID['templateVar']['sql']['query'] = "SELECT  `id`, `shortName`, `medname`, `shortDescription`, `protocol`, `domain`, `appRoot`, `homePage`,`legalAndPolicyLink` FROM `%s`.`apps_%s` WHERE appRoot = ? LIMIT 1";
...
write_to_log("STEP 15 - CODER TO DECLARE OWN VARIABLES","start_step");
	...
	$$nameSpaceID['var']['sampleFormText'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 0, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, in this instance it is to be associated with a text input");
	$$nameSpaceID['var']['sampleFormCheckbox'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 0, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script. in this instance it is to be associated with a checkbox input");

	
	/*
	$$nameSpaceID['var']['sampleFormTextArea'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script. in this instance it is to be associated with a text area input");
	$$nameSpaceID['var']['sampleFormColour'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script. in this instance it is to be associated with a colour selection input");
	$$nameSpaceID['var']['sampleFormInteger'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script. in this instance it is to be associated with a colour selection input");
	$$nameSpaceID['var']['sampleFormCheckbox'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script. in this instance it is to be associated with a checkbox input");
	$$nameSpaceID['var']['sampleFormOption'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script. in this instance it is to be associated with a checkbox input");
	$$nameSpaceID['var']['sampleFormTel'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormEmail'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormPassword'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormURL'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormButton'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormDate'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormDateTimeLocal'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormRadio'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormImage'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormFile'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormRange'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormReset'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	$$nameSpaceID['var']['sampleFormWeek'] = array("val"=> "", "DIRTY" => "", "tmpVal" => "", "argType" => 1, "mVal"=> false, "count" => 1, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "an example of a variable set in the template script, to be associated with a text input");
	*/
...
if (str_replace('\\', '/', __FILE__) == $_SERVER['SCRIPT_FILENAME']) { ?>
<!DOCTYPE html>
<html lang="<?php echo $$nameSpaceID['templateVar']['loc']['val'];?>" <?php if($$nameSpaceID['templateVar']['r2l']['val'] == true){echo 'dir="rtl"';}?> style="background-color: #f3f2f1">
<head>
	<meta charset="utf-8">
	<meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
	<meta content="Default page" name="description">
	...
	<title><?php echo $$nameSpaceID['DOM']['title']['innerHTML'];?></title>
...
<link href="/phpSample/style/gov.uk.css" rel="stylesheet" media="all">
<!--<link href="/phpSample/style/mod.css" rel="stylesheet" media="all">-->
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			...
			<form id="<?php echo $nameSpaceID . "_form";?>" accept-charset="utf-8" action="process_sampleform.php" name="<?php echo $nameSpaceID . "_form";?>" method="POST">
				<fieldset>
				<?php if($$nameSpaceID['templateVar']['debugging']['val'] && isset($$nameSpaceID['templateVar']['sr']['val']) && $$nameSpaceID['templateVar']['sr']['val'] != ""){
				...
				<div class="inputRow">
					<?php $nameOfInputField = 'sampleFormText'; //this should be the camelCase descriptive variable name for the value this input will collect.?>
					<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel" for="<?php echo $nameOfInputField;?>">
						<?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'];?>
					</label>
					<div id="<?php echo $nameOfInputField;?>Tip" class="inputTip"><?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'];?></div>				
					<input 
					tabindex="1" 
					...
					title="" 
					class="form-control field <?php echo $$nameSpaceID['templateVar']['loc']['val'];?>"
					autocomplete ="off"
					...
					data-infomsg="">
					<?php
					if(isset($$nameSpaceID['templateVar']['r2l']['val']) && $$nameSpaceID['templateVar']['r2l']['val'] == true){
						$direction = 'rtl';
					}else{
						$direction = 'ltr';
					}
					echo ${$$nameSpaceID['templateVar']['fieldValidationsNameSpace']['val']}['fn']['generateHTMLMsgBubble']($nameOfInputField,$direction,$$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);
					?>
					<div class="clearRow">&nbsp;</div>
					<div class="inputErrorMessage" id="<?php echo $nameOfInputField;?>Error"  ><?php if(count($$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']) > 0){
						echo implode(",", $$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);}else{ echo '&nbsp;';}?>
					</div>
				</div><!--end of inputRow-->
				<div class="clearRow">&nbsp;</div>
				
				<div class="inputRow shortInput">
					<?php $nameOfInputField = 'sampleFormCheckbox'; //this should be the camelCase descriptive variable name for the value this input will collect?>
					<label id="<?php echo $nameOfInputField;?>Label" class="inputLargeLabel" for="<?php echo $nameOfInputField;?>Checkbox"><?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Label']['innerHTML'] ?? 'label not defined in DOMContent.php' ;?></label>
					<div id="<?php echo $nameOfInputField;?>Tip" class="inputTip"><?php echo $$nameSpaceID['DOM'][$nameOfInputField.'Tip']['innerHTML'] ?? 'input tip not defined in DOMContent.php';?></div>				
					<input 
					tabindex="1" 
					accesskey="<?php echo $$nameSpaceID['DOM'][$nameOfInputField]['accesskey'] ?? '';?>" 
					type="checkbox"
					...
					id="<?php echo $nameOfInputField;?>" 
					title="" 
					class="form-control field <?php echo $$nameSpaceID['templateVar']['loc']['val'] ?? 'en-GB'?>"
					autocomplete ="off"
					onfocus="this.reportValidity();"
					oninput="
					this.reportValidity();
					...
					value="1" 
					<?php if($$nameSpaceID['var'][$nameOfInputField]['val'] == '1'){echo 'checked="checked"';}?>
					_required="required"  
					data-infomsg="">
					<?php
					($$nameSpaceID['templateVar']['r2l']['val'] && $$nameSpaceID['templateVar']['r2l']['val']) == true ? $direction = 'rtl' : $direction = 'ltr';
					echo ${$$nameSpaceID['templateVar']['fieldValidationsNameSpace']['val']}['fn']['generateHTMLMsgBubble']($nameOfInputField,$direction,$$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);
					?>
					<div class="clearRow">&nbsp;</div>
					<div class="inputErrorMessage" id="<?php echo $nameOfInputField;?>Error" ><?php if(count($$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']) > 0){echo implode(",", $$nameSpaceID['var'][$nameOfInputField]['varSpecificErrs']);}else{ echo '&nbsp;';}?></div>
				</div><!--end of inputRow-->
				<div class="clearRow">&nbsp;</div>	
