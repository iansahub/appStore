...
write_to_log("STEP 15 - CODER TO DECLARE OWN VARIABLES","start_step");
	...
	$$nameSpaceID['var']['colors'] = array("val"=> array(array(247,30,209),array(96,135,222),array(58,213,167),array(235,196,73),array(231,120,43)),
	"DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> true, "count" => 5, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "
	a list of rgb colors which look good together, used as backgrounds for app icons which don't have an icon image of their own.
	");
	
	$$nameSpaceID['var']['phpApps'] = array("val"=> array(), "DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> true, 
	"count" => 0, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "
	populated from appStore database with a list of all phpApps
	");
	
	$$nameSpaceID['var']['rnd'] = array("val"=> rand(0, count($$nameSpaceID['var']['colors']['val'])-1), "lastVal" => "",
	"DIRTY" => "", "tmpVal" => "", "argType" => -1, "mVal"=> true, "count" => 0, "varSpecificErrs" => array(), "mustPassOn" => true, "info" => "
	populated from appStore database with a list of all phpApps
	");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	<div class="app-width-container app-main-wrapper"><!--main layout wrapper-->
		...
		<!--breadcrumbs start-->
		<!--optionally, the breadcrumbs component goes here-->
		<!--end of breadcrumbs-->
		...
		<main id="main-content" role="main">
			...
			<!--prose start-->
			<div class="app-prose-scope"  id="prose">
				<?php echo $$nameSpaceID['DOM']['prose']['innerHTML'] ?? "this prose, a short sentence describing the page, should be set in the languagePack's DOMContent.PHP" ;?>
			</div>
			<!--end of prose-->
			...
			<div class="govuk-tabs" data-module="govuk-tabs">
				...
				<ul class="govuk-tabs__list">
					<li class="govuk-tabs__list-item govuk-tabs__list-item--selected">
						<a class="govuk-tabs__tab" href="#digital"><!--make the href meaningful instead of 'tab1'-->
							Analysis Digital
						</a>
					</li>
					<li class="govuk-tabs__list-item">
						<a class="govuk-tabs__tab" href="#COTS"><!--make the href meaningful instead of 'tab2'-->
							COTS
						</a>
					</li>
					<li class="govuk-tabs__list-item">
						<a class="govuk-tabs__tab" href="#RPosit"><!--make the href meaningful instead of 'tab2'-->
							R/POSIT
						</a>
					</li>
				</ul>
				<!--the body of the tabs-->
				<div class="govuk-tabs__panel" id="digital"><!--id must match a meaningful href above-->
					<h2 id="tab1Heading" class="govuk-heading-l"><?php echo $$nameSpaceID['DOM']['tab1Heading']['innerHTML'] ?? 'missing heading' ;?></h2>
					<!--first tab's body contents-->
					<div class="app-tabs__container js-tabs__container" id="tabs-digtal" role="tabpanel"><!--meaningful unique id needed-->
						<div class="container-fluid container-margin">
							<div class="card-deck">
								<div style="margin-bottom:15px; min-width:120px;min-height:120px" class="card">
									<!--<div style="height:100px;font-size:80px;display: flex;line-height:100%;justify-content: center;color:white;background-color:rgb(255,12,12)">+</div>-->
									<img width="120px" height="100px" style="max-width:120px" class="card-img-top" src="/appStore/assets/images/Missing_icon_the_noun_project.svg.png" alt="add missing app">
									<div style="text-align:center;">
										<a id="tab1AddMissingApp" href="addMissingAppForm.php" class="stretched-link">
										<?php echo $$nameSpaceID['DOM']['tab1AddMissingApp']['innerHTML'] ?? 'unable to load text from DOMContent.php' ;?>
										</a>
									</div>
								</div>
								<?php 
									$$nameSpaceID['templateVar']['sql']['query'] = "SELECT * FROM %s.`apps_%s` WHERE `type` IN('AD') ORDER by `shortName` ASC";
									$$nameSpaceID['templateVar']['sql']['query'] = sprintf(
										$$nameSpaceID['templateVar']['sql']['query'],
										$$nameSpaceID['templateVar']['appStore_link']['val']['db_conn_file_nameSpace']['app_database']['val'], 
										strtolower($$nameSpaceID['templateVar']['loc']['val'])
									);	
									$$nameSpaceID['templateVar']['sql']['stmt'] = mysqli_stmt_init($$nameSpaceID['templateVar']['appStore_link']['val']['db_conn']);
									mysqli_stmt_prepare($$nameSpaceID['templateVar']['sql']['stmt'],$$nameSpaceID['templateVar']['sql']['query']); 
									
									//no parameters to be bound
									//mysqli_stmt_bind_param($$nameSpaceID['templateVar']['sql']['stmt'],'s',$$nameSpaceID['templateVar']['appInfo']['val']['appRoot'] ); 
									...
									if(!$$nameSpaceID['templateVar']['sql']['result'] = mysqli_stmt_get_result($$nameSpaceID['templateVar']['sql']['stmt'])){						
										...
										//if(mysqli_num_rows($$nameSpaceID['templateVar']['result']['val'] ) != 1){
										if(mysqli_num_rows($$nameSpaceID['templateVar']['sql']['result'] ) == 0){
											
											$$nameSpaceID['templateVar']['error']['val'] = 'sql found no Analysis Digital-delivered apps, (`type`=\'AD\',) in the "'.$$nameSpaceID['templateVar']['loc']['val'].'" language appStore';
											write_to_log("FAIL!","red");
											write_to_log($$nameSpaceID['templateVar']['error']['val'],"red");

										}else{ //else of if num_rows
																
											$$nameSpaceID['var']['phpApps']['val'] = mysqli_fetch_all($$nameSpaceID['templateVar']['sql']['result'],MYSQLI_ASSOC);

											foreach($$nameSpaceID['var']['phpApps']['val'] as $$nameSpaceID['var']['phpApps']['tmpVal']){
												while($$nameSpaceID['var']['rnd']['val'] == $$nameSpaceID['var']['rnd']['lastVal']){
													$$nameSpaceID['var']['rnd']['val'] = rand(0, count($$nameSpaceID['var']['colors']['val'])-1);
												}
												$$nameSpaceID['var']['rnd']['lastVal'] = $$nameSpaceID['var']['rnd']['val'];

												print '<div style="margin-bottom:15px; min-width:120px;min-height:120px" class="card" style="color:'. $$nameSpaceID['var']['phpApps']['tmpVal']['fontColour'].'; background-color:'.$$nameSpaceID['var']['phpApps']['tmpVal']['backgroundColourDark'].' !important">'.PHP_EOL;
												if(file_exists($$nameSpaceID['var']['phpApps']['tmpVal']['image'])){
													print '<img style="max-width:120px" width="120px" height="100px" class="card-img-top" src="'.$$nameSpaceID['var']['phpApps']['tmpVal']['image'].'" alt="'.$$nameSpaceID['var']['phpApps']['tmpVal']['shortName'].'">'.PHP_EOL;
												}else{
													print '<div style="height:100px;font-size:80px;display: flex;line-height:100%;justify-content: center;color:white;background-color:rgb('.implode(",",$$nameSpaceID['var']['colors']['val'][$$nameSpaceID['var']['rnd']['val']]).')">';
													echo substr($$nameSpaceID['var']['phpApps']['tmpVal']['shortName'],0,1);
													print '</div>';

												}
												//var_dump($$nameSpaceID['var']['phpApps']['tmpVal']);
												print '<div style="text-align:center;"><a href="appDetailsForm.php?appID='.$$nameSpaceID['var']['phpApps']['tmpVal']['id'] . '" class="stretched-link">';
												echo $$nameSpaceID['var']['phpApps']['tmpVal']['shortName'];
												print '</a></div>'.PHP_EOL;
												print '</div>'.PHP_EOL;
											}
								...
								?>
									...
									<div style="margin-bottom:15px; min-width:120px;min-height:120px" class="card"><div style="height:100px;font-size:80px;display: flex;line-height:100%;justify-content: center;color:white;background-color:rgb(255,12,12)">+</div><div style="text-align:center;"><a href="createNewPHPAppForm.php" class="stretched-link">Create PHP App</a></div></div>
							</div><!--end of first tab's in-body grid card deck-->
						</div><!--end of first tab's in-body grid container-->
					</div><!--end of first tab's body-->
				</div><!--end of first tab-->
				<div class="govuk-tabs__panel govuk-tabs__panel--hidden" id="COTS"><!--id must match a meaningful href above-->
					<h2 id="tab2Heading" class="govuk-heading-l"><?php echo $$nameSpaceID['DOM']['tab1Heading']['innerHTML'] ?? 'missing heading' ;?></h2>
					<!--second tab's body contents-->
					<div class="app-tabs__container js-tabs__container" id="tabs-COTS" role="tabpanel"><!--meaningful unique id needed-->
						<div class="container-fluid container-margin">
							<div class="card-deck">
								<div style="margin-bottom:15px; min-width:120px;min-height:120px" class="card">
									<!--<div style="height:100px;font-size:80px;display: flex;line-height:100%;justify-content: center;color:white;background-color:rgb(255,12,12)">+</div>-->
									<img width="120px" height="100px" style="max-width:120px" class="card-img-top" src="/appStore/images/Missing_icon_the_noun_project.svg.png" alt="add missing app">
									<div style="text-align:center;">
										<a id="tab2AddMissingApp" href="addMissingAppForm.php" class="stretched-link">
											<?php echo $$nameSpaceID['DOM']['tab2AddMissingApp']['innerHTML'] ?? 'unable to load text from DOMContent.php' ;?>
										</a>
									</div>
								</div>
								<?php 
									$$nameSpaceID['templateVar']['sql']['query'] = "SELECT * FROM %s.`apps_%s` WHERE `type` IN('COTS') ORDER by `shortName` ASC";
									$$nameSpaceID['templateVar']['sql']['query'] = sprintf(
										$$nameSpaceID['templateVar']['sql']['query'],
										$$nameSpaceID['templateVar']['appStore_link']['val']['db_conn_file_nameSpace']['app_database']['val'], 
										strtolower($$nameSpaceID['templateVar']['loc']['val'])
									...
									if(!$$nameSpaceID['templateVar']['sql']['result'] = mysqli_stmt_get_result($$nameSpaceID['templateVar']['sql']['stmt'])){						
										...
										if(mysqli_num_rows($$nameSpaceID['templateVar']['sql']['result'] ) == 0){
											...
											$$nameSpaceID['templateVar']['error']['val'] = 'sql found no COTS apps in the "'.$$nameSpaceID['templateVar']['loc']['val'].'" language appStore';
											write_to_log("FAIL!","red");
											write_to_log($$nameSpaceID['templateVar']['error']['val'],"red");
								...
								?>
									...
									<div style="margin-bottom:15px; min-width:120px;min-height:120px" class="card"><div style="height:100px;font-size:80px;display: flex;line-height:100%;justify-content: center;color:white;background-color:rgb(255,12,12)">+</div><div style="text-align:center;"><a href="createNewPHPAppForm.php" class="stretched-link">Create PHP App</a></div></div>
							</div><!--end of second tab's in-body grid card deck-->
						</div><!--end of second tab's in-body grid container-->
					</div><!--end of app-tabs__container-->
				</div><!--end of second tabs panel-->
				<div class="govuk-tabs__panel govuk-tabs__panel--hidden" id="RPosit"><!--id must match a meaningful href above-->
					<h2 id="tab3Heading" class="govuk-heading-l"><?php echo $$nameSpaceID['DOM']['tab1Heading']['innerHTML'] ?? 'missing heading' ;?></h2>
					<!--third tab's body contents-->
					<div class="app-tabs__container js-tabs__container" id="tabs-RPosit" role="tabpanel"><!--meaningful unique id needed-->
						<div class="container-fluid container-margin">
							<div class="card-deck">
								<div style="margin-bottom:15px; min-width:120px;min-height:120px" class="card">
									<!--<div style="height:100px;font-size:80px;display: flex;line-height:100%;justify-content: center;color:white;background-color:rgb(255,12,12)">+</div>-->
									<img width="120px" height="100px" style="max-width:120px" class="card-img-top" src="/appStore/images/Missing_icon_the_noun_project.svg.png" alt="add missing app">
									<div style="text-align:center;">
										<a id="tab3AddMissingApp" href="addMissingAppForm.php" class="stretched-link">
											<?php echo $$nameSpaceID['DOM']['tab3AddMissingApp']['innerHTML'] ?? 'unable to load text from DOMContent.php' ;?>
										</a>
									</div>
								</div>
								<?php 
									$$nameSpaceID['templateVar']['sql']['query'] = "SELECT * FROM %s.`apps_%s` WHERE `type` IN('R') ORDER by `shortName` ASC";
									$$nameSpaceID['templateVar']['sql']['query'] = sprintf(
										$$nameSpaceID['templateVar']['sql']['query'],
										$$nameSpaceID['templateVar']['appStore_link']['val']['db_conn_file_nameSpace']['app_database']['val'], 
										strtolower($$nameSpaceID['templateVar']['loc']['val'])
